...
/**
 * 方便自定义控件继承的LinearLayout
 * Created by huichuan on 16/9/22.
 */
public abstract class BaseCustomLinearLayout<T> extends LinearLayout {
    ...
    public BaseCustomLinearLayout(Activity context) {
        this(context,null);
    }
    ...
    public BaseCustomLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
